...
import {Visualization, Track, Site} from "@/modules/visualization";
...
export class VisualizationRepository
{
    ...
    async create(timeline: Timeline, site: Site): Promise<Visualization>
    {
        ...
        let currentCursor = site.cursor;
        let topRangeTrack, bottomRangeTrack;

        [topRangeTrack, currentCursor] = await this.trackService.createTrackByRange({
        ...
        for (const branch of branches) {
            const [branchTracks, newCursor] = await this.trackService.createTracksByTasks(branch.tasks, branch.footprint, {
                begin: timeline.begin,
                end: timeline.end,
            }, {
                ...site,
        ...
        [bottomRangeTrack] = await this.trackService.createTrackByRange({
            begin: timeline.begin,
            end: timeline.end,
        }, {
            ...site,
